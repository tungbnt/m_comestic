...
class CustomSlider extends StatefulWidget {
  ...
  ///
  /// If not null, a secondary track using [CustomSlider.secondaryActiveColor] color
  /// is drawn between the thumb and this value, over the inactive track.
  ///
  /// If less than [CustomSlider.value], then the secondary track is not shown.
  ///
  /// It can be ideal for media scenarios such as showing the buffering progress
  /// while the [CustomSlider.value] shows the play progress.
  ...
  /// * [CustomSlider] will use [activeColor].
  ...
  void describeSemanticsConfiguration(SemanticsConfiguration config) {
    ...
    if (semanticFormatterCallback != null) {
      ...
      config.increasedValue =
          semanticFormatterCallback!(_state._lerp(clampDouble(value + _semanticActionUnit, 0.0, 1.0)));
...
/// The default shape of a [CustomSlider]'s track.
///
...
/// [SliderThemeData.trackHeight]. The color is determined by the [CustomSlider]'s
...
/// See also:
///
///  * [CustomSlider], for the component that is meant to display this shape.
...
///    [CustomSlider]'s track.
///  * [RectangularSliderTrackShape], for a similar track with sharp edges.
class CustomRoundedRectSliderTrackShape extends SliderTrackShape with CustomBaseSliderTrackShape {
...
///    stadium-like edges.
mixin CustomBaseSliderTrackShape {
  /// Returns a rect that represents the track bounds that fits within the
  /// [CustomSlider].
  ///
  /// The width is the width of the [CustomSlider] or [RangeSlider], but padded by
